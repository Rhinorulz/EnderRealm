...
recipes.addShaped(<actuallyadditions:woodenPaxel>, [[<minecraft:wooden_axe>, <minecraft:wooden_pickaxe>, <minecraft:wooden_shovel>], [<dungeontactics:wooden_sword>, <minecraft:wooden_hoe>, null], [null, null, null]]);
recipes.remove(<actuallyadditions:stonePaxel>);
recipes.addShaped(<actuallyadditions:stonePaxel>, [[<minecraft:stone_axe>, <minecraft:stone_pickaxe>, <minecraft:stone_shovel>], [<dungeontactics:stone_sword>, <minecraft:stone_hoe>, null], [null, null, null]]);
recipes.remove(<actuallyadditions:ironPaxel>);
recipes.addShaped(<actuallyadditions:ironPaxel>, [[<minecraft:iron_axe>, <minecraft:iron_pickaxe>, <minecraft:iron_shovel>], [<dungeontactics:iron_sword>, <minecraft:iron_hoe>, null], [null, null, null]]);
recipes.remove(<actuallyadditions:goldPaxel>);
recipes.addShaped(<actuallyadditions:goldPaxel>, [[<minecraft:golden_axe>, <minecraft:golden_pickaxe>, <minecraft:golden_shovel>], [<dungeontactics:golden_sword>, <minecraft:golden_hoe>, null], [null, null, null]]);
recipes.remove(<actuallyadditions:diamondPaxel>);
recipes.addShaped(<actuallyadditions:diamondPaxel>, [[<minecraft:diamond_axe>, <minecraft:diamond_pickaxe>, <minecraft:diamond_shovel>], [<dungeontactics:diamond_sword>, <minecraft:diamond_hoe>, null], [null, null, null]]);
