...
recipes.addShaped(<mob_grinding_utils:spikes> * 4, [[null, null, null], [null, <dungeontactics:iron_sword>.withTag({ENABLED: 1 as byte, RARITY: 1}), null], [<dungeontactics:iron_sword>, <minecraft:iron_block>, <dungeontactics:iron_sword>]]);
